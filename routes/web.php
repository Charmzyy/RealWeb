...
use App\Http\Controllers\threeController;
...
Route::get('/en/three/', [threeController::class, 'view']);
Route::get('/en/three/swift', [threeController::class, 'swift']);
Route::get('/en/three/witting', [threeController::class, 'witting']);
Route::get('/en/three/hallie', [threeController::class, 'hallie']);
Route::get('/en/three/haler', [threeController::class, 'haler']);
Route::get('/en/three/hagenes', [threeController::class, 'hagenes']);
Route::get('/en/three/ardella', [threeController::class, 'ardella']);
Route::get('/en/three/kshlerin', [threeController::class, 'kshlerin']);
Route::get('/en/three/natasha', [threeController::class, 'natasha']);
Route::get('/en/three/fanny', [threeController::class, 'fanny']);
Route::get('/en/signup', [HomeController::class, 'reg']);
Route::get('/en/signin', [HomeController::class, 'index']);
Route::get('/en/plans', [PlanController::class, 'index']);
Route::get('/en/plan', [PlanController::class, 'show']);
Route::post('/subscription', 'SubscriptionController@create')->name('subscription.create');
Route::get('/en/pay', [PlanController::class, 'review']);
